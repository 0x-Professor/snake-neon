...
export const SnakeGame: React.FC = () => {
  ...
  // Separate selectors to prevent re-render cascades
  ...
  // Stable key handler - no dependencies to prevent re-creation
  ...
  // Keyboard event listener - only depends on stable handleKeyPress
  useEffect(() => {
